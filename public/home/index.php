        ...
        <header id="home-header">
            <div class="headerNavigation">
                <nav id="main-nav">
                    <ul>
                        <li>
                            <a href="#" class="navigationLink">About Me</a>
                        </li>
                        <li>
                            <a href="#" class="navigationLink">My Work</a>
                        </li>
                        <li>
                            <a href="#" class="navigationLink">My Resume</a>
                        </li>
                        <li>
                            <a href="#" class="navigationLink">Contact Me</a>
                        </li>
                    </ul>
                </nav>
            </div>
